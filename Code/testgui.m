...
% Interpretation based on Jaccard Index
if Aj >= 95
    diagnosis = 'Cervical cancer cell detected';
elseif Aj >= 80
    diagnosis = 'Possibly a cervical cancer cell';
else
    diagnosis = 'No evidence of cervical cancer cell';
end
% Display the diagnosis
msgbox(sprintf('Diagnosis: %s\n', diagnosis));
